...
<head>
    ...
    <style>
        body {
            height: 100vh; /* Usar 100vh para ocupar toda la altura de la ventana */
            width: 100%;
            background: #080f1a;
            overflow: hidden;
            ...
            margin: 40px; /* Aumentar el margen al body */
        }

        .container {
            position: relative; /* Cambiar a relative para que los elementos internos se posicionen correctamente */
            top: 0; /* Ajustar la posición superior */
            transform: translateY(-30px); /* Alejar todo hacia arriba */
        }

        .glass {
            height: 700px; /* Ajustar la altura de la flor */
            width: 600px;
            background: #122139;
